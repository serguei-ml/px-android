...
public class DiscountTest {
    ...
    public void setUp() {
        ...
        campaign = new Campaign.Builder(MERCHANT_DISCOUNT_ID).build();

        card = new Visa(FakeCard.CardState.APRO, Country.ARGENTINA);
    }

    @Test
    public void whenMerchantDiscountIsAppliedAndHasPaymentProcessorThenShowMerchantDiscountAndGetCongrats() {
        final MercadoPagoCheckout.Builder builder =
    ...
    /*
    @Test
    public void whenCodeDiscountIsAppliedAndPaidWithCreditCardThenGetCongrats() {
        //TODO
        final MercadoPagoCheckout.Builder builder =
        ...
        final CongratsPage congratsPage = discountTestFlow.runCreditCardPaymentFlowWithCodeDiscount(card, 1, null);
        assertNotNull(congratsPage);
    }
    */
}
